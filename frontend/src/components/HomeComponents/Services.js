        ...
        <div className='row'>
          <div className='col-lg-3 mb-3 d-flex'>
            <div className='card rounded-0 flex-fill'>
              <img src={curriculum} className='card-img-top' alt='curriculum' />
              {lan ? (
                <div className='card-body'>
                  <h5 className='card-title'>GIÁO TRÌNH</h5>
                  <p className='card-text'>
                    Chương trình giảng dạy bao gồm: lý thuyết, thực hành & trình
                    diễn. Chúng tôi tin rằng nền tảng nhạc lý căn bản vững chắc
                    rất quan trọng đối với mọi nhạc sĩ. Vì nhạc lý căn bản sẽ
                    luôn được áp dụng trong mọi thể nhạc như nhạc cổ điển cho
                    tới nhạc cận đại. Trường có nhiều phương pháp giảng dạy dể
                    hiểu, sống động, thực tế và sẽ áp dụng phương pháp phù hợp
            ...
            <div className='card rounded-0 flex-fill'>
              ...
              {lan ? (
                <div className='card-body'>
                  ...
                  <p className='card-text'>
                    Đội ngũ giáo viên chuyên nghiệp của chúng tôi tốt nghiệp từ
                    những trường âm nhạc như đại học Georgia State University,
                    đại học University of Georgia, nhạc viện Atlanta và nhạc
                    viện Sài Gòn. Các giáo viên của chúng tôi thông thạo tiếng
                    Việt và tiếng Anh và sẽ hỗ trợ tốt hơn trong giao tiếp giữa
                    học sinh, giáo viên và phụ huynh. Các giáo viên của chúng
                    tôi được đào tạo sư phạm để giảng dạy từ lớp nhạc cơ bản tới
                    nâng cao
                  </p>
                </div>
              ) : (
            ...
            <div className='card rounded-0 flex-fill'>
              ...
              {lan ? (
                <div className='card-body'>
                  ...
                  <p className='card-text'>
                    Phòng học riêng biệt giúp cho các em học sinh đạt được hiệu
                    quả cao nhất với trải nghiệm một thầy-một trò. Camera giám
                    sát được trang bị cho từng phòng học & sẽ phát trực tiếp qua
                    phòng đợi nhằm đảm bảo an toàn cho học sinh. Phòng học trang
                    bị hầu hết các nhạc cụ như piano, guitar hoặc trống cho học
                    sinh sử dụng trong giờ học.
                  </p>
                </div>
              ) : (
                <div className='card-body'>
            ...
            <div className='card rounded-0 flex-fill'>
              ...
              {lan ? (
                <div className='card-body'>
                  ...
                  <p className='card-text'>
                    Học sinh sẽ có cơ hội trình diễn cho giáo viên và phụ huynh
                    trong các chương trình âm nhạc của trường Doremi. Học sinh
                    sẽ có kinh nghiệm trình diễn trước khán giả là giáo viên,
                    phụ huynh và bạn học. Chúng tôi cũng tổ chức chương trình
                    hòa nhạc lớn hằng năm để giúp các em học sinh có được trải
                    nghiệm âm thanh, ánh sáng sân khấu chuyên nghiệp với sự tán
                    thưởng nồng nhiệt của khán giả trong chương trình âm nhạc
                    của năm.
                  </p>
                </div>
              ) : (
